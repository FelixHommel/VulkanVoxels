#ifndef VULKAN_VOXELS_SRC_ENGINE_CORE_DEVICE_HPP
#define VULKAN_VOXELS_SRC_ENGINE_CORE_DEVICE_HPP
...
#endif //! VULKAN_VOXELS_SRC_ENGINE_CORE_DEVICE_HPP
